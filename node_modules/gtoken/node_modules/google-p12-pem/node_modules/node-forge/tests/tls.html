...
<div class="content">
    ...
    <fieldset class="section">
        ...
        <div id="controls">
            <button id="init" onclick="return client_init(false);">init</button>
            <button id="init_primed" onclick="return client_init(true);">init primed</button>
            <button id="cleanup" onclick="return client_cleanup();">cleanup</button>
            <button id="send" onclick="return client_send();">send</button>
            <button id="send10" onclick="return client_send_10();">send 10</button>
            <button id="stress" onclick="return client_stress();">stress</button>
            <button id="client_cookies" onclick="return client_cookies();">cookies</button>
            <button id="clear_cookies" onclick="return client_clear_cookies();">clear cookies</button>
            <button id="websocket" onclick="return websocket_test();">websocket test</button>
            <button id="websocket-webid" onclick="return websocket_webid('localhost', 8080);">websocket webid test
            </button>
        </div>
    </fieldset>
