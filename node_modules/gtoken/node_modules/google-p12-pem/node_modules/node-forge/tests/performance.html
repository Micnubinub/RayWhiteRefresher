...
<div class="content">
    ...
    <fieldset class="section">
        ...
        <div id="random_controls">
            <button id="random" onclick="return test_random();">paint random</button>
            <button id="clear" onclick="return canvas_clear();">clear</button>
        </div>
        <canvas id="canvas" width="100" height="100"></canvas>
        <div id="buffer_controls">
            <button id="buffer_fill" onclick="return test_buffer_fill();">buffer fill</button>
            <button id="buffer_xor" onclick="return test_buffer_xor();">buffer xor</button>
        </div>
        <div id="base64_controls">
            <button id="base64_encode" onclick="return test_base64_encode();">base64 encode</button>
            <button id="base64_decode" onclick="return test_base64_decode();">base64 decode</button>
        </div>
        <div id="hash_controls">
            <button id="md5" onclick="return test_md5();">md5</button>
            <button id="sha1" onclick="return test_sha1();">sha1</button>
            <button id="sha256" onclick="return test_sha256();">sha256</button>
        </div>
        <div id="aes_controls">
            <button id="aes_128" onclick="return aes_128();">aes-128</button>
            <button id="aes_128_cbc" onclick="return aes_128_cbc();">aes-128 cbc</button>
        </div>
    </fieldset>
</div>
</body>
