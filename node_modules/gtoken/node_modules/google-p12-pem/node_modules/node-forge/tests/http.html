...
<div class="content">
    ...
    <fieldset class="section">
        ...
        <button id="init" onclick="return client_init();">init</button>
        ...
        <button id="add_cookies" onclick="return request_add_cookies();">add cookies</button>
        <button id="get_cookies" onclick="return response_get_cookies();">get cookies</button>
    </fieldset>
