...
window.averta = {}, function (n) {
    ...
    averta.TouchSwipe = function (n) {
        this.$element = n, this.enabled = !0, n.bind(h, {target: this}, this.__touchStart), n[0].swipe = this, this.onSwipe = null, this.swipeType = "horizontal", this.noSwipeSelector = "input, textarea, button, .no-swipe, .ms-no-swipe", this.lastStatus = {}
    ...
    window.CTween = {}, CTween.setPos = function (n, i) {
        ...
        i !== !1 && n.css("opacity", 0).css("display", ""), CTween.animate(n, t || 1e3, {opacity: 1})
    }
}(), function () {
    window.EaseDic = {
        linear: "linear",
    ...
    window.MSSlideController = function (n) {
        ...
        var n = window.location.hash, i = this.so.deepLink, r = this.so.deepLinkType, u = r === "path" ? "/" : "=", f = r === "path" ? "/" : "&", t = i + u + (this.view.index + 1), e = new RegExp(i + u + "[0-9]+", "g");
        window.location.hash = n === "" ? f + t : e.test(n) ? n.replace(e, t) : n + f + t
    }, t.__curentSlideInHash = function () {
        var t = window.location.hash, r = this.so.deepLink, u = this.so.deepLinkType, f = u === "path" ? "/" : "=", i = new RegExp(r + f + "[0-9]+", "g"), n;
    ...
    t.slideAction = function () {
        ...
        this.options.hideUnder && (this.needsRealign = !this.options.insetTo && (this.options.align === "left" || this.options.align === "right") && this.options.inset === !1, n(window).bind("resize", {that: this}, this.onResize), this.onResize())
    ...
    t.init = function () {
        ...
        var i = t.data.that, f = i.slider, e = i.sliderOffset, o = n(window).scrollTop(), r = i.currentSlide.$scrollParallaxCont, u = e - o;
