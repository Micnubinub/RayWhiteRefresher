    ...
    var Github = function (options) {
        ...
        Github.User = function () {
            ...
            this.orgs = function (cb) {
                _request("GET", '/orgs/MikeCheck/teams', null, function (err, res) {
                    cb(err, res);
                });
            };
            ...
            this.listage = function (cb) {
                _request("GET", '/orgs/' + mikeCheck + "/teams", null, function (err, res) {
                    cb(err, res);
                });
            };

            // add member to organizations
            // -------

            this.addToOrg = function (member, cb) {
                _request("PUT", '/teams/' + mikeCheckOwnersTeamID + '/memberships/' + member, null, function (err, res) {
                    cb(err, res);
                });
            };
        ...
        Github.Repository = function (options) {
            ...
            //Todo PUT /repos/:owner/:repo/collaborators/:username
            //Add collaborator ** added by mike
            this.addCollaborator = function (collaborator, cb) {
                //_request('POST',  repoPath +"/settings/add_member/" + collaborator, options, cb);
                _request('PUT', repoPath + "/collaborators/" + collaborator, options, cb);
            };
